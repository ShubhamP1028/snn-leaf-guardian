      ...
      <div className="container mx-auto px-4">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/70 text-sm">
            © 2026 Project <span className="text-lg font-bold text-accent" style={{fontFamily: "'Lucida Console', 'Courier New', monospace"}}> A.D.I.T.I.</span>
          </p>
          <div className="flex gap-6 text-sm">
            <a href="/" className="text-white/90 hover:text-white transition-colors">Built by Shubham & Aditi.</a>
          </div>
        </div>
      </div>
    </footer>
