       ...
       <div className="container mx-auto px-4 relative z-10">
         ...
         <div className="max-w-4xl mx-auto">
           ...
           >
                   ...
                   >
                     ...
                     {isAnalyzing && (
                       <div className="absolute inset-0 bg-primary/20">
                         <motion.div
                           className="absolute left-0 right-0 h-1 bg-accent shadow-[0_0_20px_hsl(38,92%,50%)]"
                           animate={{ top: ["0%", "100%", "0%"] }}
             ...
             {/* Results Panel */}
             <div className="rounded-2xl border border-border bg-card p-6 min-h-[320px] flex flex-col">
               <AnimatePresence mode="wait">
