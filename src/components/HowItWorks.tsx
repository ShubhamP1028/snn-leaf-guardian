     ...
     <section id="how-it-works" className="py-20 bg-card relative overflow-hidden">
       <div className="container mx-auto px-4">
               ...
               >
                 ...
                 <div className="flex items-center justify-center mb-6">
                   <motion.div
                     ...
                     className={`w-16 h-16 rounded-2xl ${step.color} flex items-center justify-center relative z-10`}
                   >
         ...
         <motion.div
           ...
           className="mt-16 p-8 rounded-3xl bg-secondary/50 border border-border"
         >
           ...
           <div className="flex items-center justify-center gap-4 md:gap-8 flex-wrap">
             ...
             <div className="flex flex-col items-center">
               ...
               <div className="text-xs text-muted-foreground mt-2">224×224×3</div>
             </div>
             ...
             {[256, 128, 64].map((neurons, layerIdx) => (
               <div key={layerIdx} className="flex flex-col items-center">
                 ...
                 <div className="flex flex-col gap-1">
                   {[...Array(3)].map((_, i) => (
                     <motion.div
                       ...
                       className="w-8 h-8 rounded-lg bg-accent/30 border border-accent/40 flex items-center justify-center"
                       animate={{ 
                         scale: [1, 1.1, 1],
                         backgroundColor: ["hsl(38 92% 50% / 0.2)", "hsl(38 92% 50% / 0.5)", "hsl(38 92% 50% / 0.2)"]
                       }}
                       transition={{ 
                         duration: 0.5, 
                         repeat: Infinity, 
                 ...
                 <div className="text-xs text-muted-foreground mt-2">{neurons} LIF</div>
               </div>
             ))}
             ...
             <div className="flex flex-col items-center">
               ...
               <div className="text-xs text-muted-foreground mt-2">38 Classes</div>
             </div>
           </div>
         </motion.div>
       </div>
