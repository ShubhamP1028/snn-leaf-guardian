...
export function DiseaseLibrary() {
  ...
  return (
    <section id="diseases" className="section-padding bg-background relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Disease Grid - White cards with borders */}
            ...
            {filteredDiseases.map((disease, index) => (
              ...
              >
                <div className={`p-5 rounded-2xl border bg-card hover:shadow-lg transition-all duration-300 ${
                  selectedDisease === disease.id ? "border-accent shadow-lg" : "border-border"
                }`}>
